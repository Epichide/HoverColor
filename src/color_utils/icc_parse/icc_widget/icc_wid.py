...
from PyQt5.QtWidgets import (
    ...
    QHBoxLayout, QMessageBox, QTabWidget, QWidget, QVBoxLayout, QMenu
)
...
from ..iccinspector import iccProfile
from ..icc_extend import update_custom_icc_cache_proj,load_custom_icc
...
class ICCRadio(QtWidgets.QRadioButton):
    def __init__(self,parent=None,text="",itype="icc"):
        ...
        elif os.path.exists(text): # icc file
            self.icc_file=os.path.abspath(text)
            self.update_profile(text)
        else:
